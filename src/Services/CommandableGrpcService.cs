...
namespace PipServices3.Grpc.Services
{
	...
	/// - *:endpoint:http:*:1.0          (optional) <a href="https://rawgit.com/pip-services3-dotnet/pip-services3-grpc-dotnet/master/doc/api/class_pip_services_1_1_grpc_1_1_services_1_1_http_endpoint.html">HttpEndpoint</a> reference
	/// </summary>
	/// <example>
	/// <code>
